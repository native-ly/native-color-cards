...
exports.Icon = native_1.default(vector_icons_1.Ionicons)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 28px;\n  margin-top: -2px;\n  text-align: center;\n"], ["\n  width: 28px;\n  margin-top: -2px;\n  text-align: center;\n"])));
var templateObject_1;
...
var native_1 = __importDefault(__webpack_require__(/*! styled-components/native */ "styled-components/native"));
var react_native_drag_sort_1 = __importDefault(__webpack_require__(/*! react-native-drag-sort */ "react-native-drag-sort"));
exports.Base = native_1.default(react_native_drag_sort_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject([""], [""])));
var templateObject_1;
...
exports.Card = function (_a) {
    ...
    return (react_1.default.createElement(react_native_1.Animated.View, { style: {
        ...
        react_1.default.createElement(Card_1.Base, __assign({ activeScale: !scalable || flat ? 1 : 0.96, onPress: function () { return !flat && press(); }, as: flat ? react_native_1.TouchableOpacity : Card_1.Base, onLongPress: function () { return !flat && longPress(); }, color: backgroundColor, shadow: shadow && !flat, flat: flat }, props),
            icon && react_1.default.createElement(Icon_1.Icon, { name: icon, color: color, size: 30 }),
            !flat &&
                (editable ? (react_1.default.createElement(CheckBox_1.Check, __assign({ checked: checked }, checkBoxProps))) : (react_1.default.createElement(Options_1.Options, __assign({ color: color, isDark: backgroundColor }, optionsProps)))),
            react_1.default.createElement(Card_1.Info, null,
                ...
                subtitle
                    ? !flat && (react_1.default.createElement(Title_1.Title, { numberOfLines: 1, color: color }, subtitle))
                    : null),
            gradient && !flat && (react_1.default.createElement(Gradient_1.Gradient, __assign({ color: color, faded: checked && editable }, gradientProps))))));
};
...
exports.Check = function (_a) {
    ...
    return (react_1.default.createElement(CheckBox_1.Base, __assign({ checked: checked }, props), checked ? react_1.default.createElement(vector_icons_1.Ionicons, { color: "#fff", name: "md-checkmark", size: 18 }) : null));
};
...
exports.List = function (props) {
    var _a = react_1.useState(false), editable = _a[0], setEditable = _a[1];
    ...
    return (react_1.default.createElement(context_1.ListContext.Provider, { value: {
            ...
            checked: checked,
            check: function () { return setChecked(true); },
        } },
        react_1.default.createElement(List_1.Base, __assign({}, props))));
};
...
exports.Options = function (_a) {
    ...
    return (react_1.default.createElement(Options_1.Base, __assign({}, props),
        react_1.default.createElement(Options_1.BlurLayer, { faded: faded, tint: color_1.default(isDark).isDark() ? 'dark' : 'light', intensity: 60 },
            react_1.default.createElement(vector_icons_1.Ionicons, { name: "ios-more", color: color, size: 22 }))));
};
...
exports.Save = function (_a) {
    var props = __rest(_a, []);
    return (react_1.default.createElement(react_native_1.Button, __assign({ onPress: function () { return console.log('hello'); } }, props)));
};
...
exports.Title = function (_a) {
    ...
    return (react_1.default.createElement(Title_1.Base, __assign({ color: color, isPrimary: isPrimary }, props), children));
};
...
exports.ListContext = react_1.default.createContext({
    editable: false,
    setEditable: function () { return false; },
    checked: false,
...
Object.defineProperty(exports, "__esModule", { value: true });
var animations_1 = __webpack_require__(/*! ./animations */ "./src/helpers/animations.tsx");
...
Object.defineProperty(exports, "__esModule", { value: true });
var List_1 = __webpack_require__(/*! ./components/List */ "./src/components/List.tsx");
exports.List = List_1.List;
var Card_1 = __webpack_require__(/*! ./components/Card */ "./src/components/Card.tsx");
exports.Card = Card_1.Card;
var Save_1 = __webpack_require__(/*! ./components/Save */ "./src/components/Save.tsx");
...
/*!*****************************************!*\
  !*** external "react-native-drag-sort" ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("react-native-drag-sort");
